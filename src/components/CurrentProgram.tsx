...
const CurrentProgram: React.FC<CurrentProgramProps> = ({ currentProgram }) => {
  if (!currentProgram) {
    return null;
  }
  ...
  return (
    <div 
      className="w-full bg-gradient-to-r from-[#ad1917] via-[#f37335] to-[#fda63d] text-white py-2 px-3 rounded-b-lg shadow-lg border-t-2 border-white/20 animate-fade-in"
      style={{
